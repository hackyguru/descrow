      ...
      >
        ...
        <chakra.p mb="3" fontSize={{ base: "lg", md: "xl" }} color="#47586B">
          <VStack align="initial">
            <span>
              Share the unique link with your buyer. Once the buyer deposits the
              tokens in the escrow address, you will be redirected to the next
              step.
            </span>
            <br></br>
            <br />
            ...
            >
              ...
              <b>Status : </b>
              <Spacer />
              Payment not received in escrow wallet
              <Spacer />
            </Alert>
            <br></br>
            <span>
              <Box paddingTop="10">
                ...
                >
                  ...
                  >
                    http://localhost:3000/buy/uIOldfnt21
                  </chakra.a>
                  <Center>
                    <IconButton
